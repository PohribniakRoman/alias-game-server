...
class Game {
    ...
    startGame() {
        ...
        this.participants.forEach(user => {
            if (this.game.hasOwnProperty(user.team)) {
                this.game[user.team].participants.push(Object.assign(Object.assign({}, user.participant), { sockets: user.sockets, myMove: false }));
            }
            else {
                this.game[user.team] = { participants: [Object.assign(Object.assign({}, user.participant), { sockets: user.sockets, myMove: true })], point: 0 };
            }
        });
    }
    join(participant, socket) {
        ...
        (_a = this.participants) === null || _a === void 0 ? void 0 : _a.forEach(user => {
